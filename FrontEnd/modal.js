...
async function afficherProjets() {
  ...
  SupprimerLaGalerie.classList.add("btn-reset");
  SupprimerLaGalerie.textContent = "Supprimer la gallerie";
  SupprimerLaGalerie.addEventListener("click", supprimerProjets);
  ...
  for (let i = 0; i < projets.length; i++) {
    ...
    sectionGallery.appendChild(SupprimerLaGalerie);
  }
}
...
async function openModalAjoutPhoto() {
  ...
  const inputImageContent = document.querySelector(".input-content-image");
